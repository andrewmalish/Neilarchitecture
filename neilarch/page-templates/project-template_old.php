	...
	//	echo '<img style="navigation-img" src="http://s9.web-servers.com.au/~neilarch/dev/wp-content/themes/neilarch/images/projects-box-navigation-bg.png" />';
		...
		//for($i=0; $i<3; $i++){ //repeat the cycle
			foreach($projects as $project){ 
				...
				echo '<a href="'.get_permalink($project->ID).'">'.get_the_post_thumbnail($project->ID, "project_preview").'</a>';
		...
		<script>
			...
			jQuery(window).load(function(){
				...
				jQuery(".project-box.navigation").height(needheight-1);
				//console.log(needheight-1);
			
				 jQuery(window).resize(function(){
				
					needheight = jQuery(".project-box:nth-child(2) img").height();
					//console.log(needheight-1);
					jQuery(".project-box.navigation").height(needheight-1);
